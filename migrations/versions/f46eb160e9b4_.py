...
Revision ID: f46eb160e9b4
Revises: 
Create Date: 2024-03-14 18:01:30.498998
...
def upgrade():
    ...
    sa.Column('encounterRate', sa.Numeric(precision=3, scale=2), nullable=True),
    sa.Column('catchRate', sa.Numeric(precision=3, scale=2), nullable=True),
    sa.Column('captured', sa.Boolean(), nullable=True),
    sa.Column('typeId', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['typeId'], ['pokemon_types.id'], ),
    sa.PrimaryKeyConstraint('id'),
